...
HD_PWD='C:/Users/Luke/Desktop/Xilinx/factorial/factorial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_factorial.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGA_factorial.tcl
