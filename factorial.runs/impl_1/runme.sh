...
HD_PWD='C:/Users/Luke/Desktop/Xilinx/factorial/factorial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_factorial.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPGA_factorial.tcl -notrace
